...
- ~~Web 前端页面（形态已定 B/S；P1 仅 API，完整页面 P2 前做）~~ —— 已结项（2026-09-20）：8 条线全量接入 + 视觉基线对齐 meowa.ai（默认亮色 + 暗色切换），规格 docs/dev/web-ui-style-spec.md v2；跨会话任务历史（GET /api/v1/jobs）留待后续轮
